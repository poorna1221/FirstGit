...
document.forms["startshopping"].submit();
}
 ...
 <div class="menuBar">
       ...
       <div class="contentWrapper"> 
			<div class="accSettingsList">
				<p class="blueHeadingH2">My Account  Settings           	</p>
	 ...
	 <div class="login_container clearfix">
	    ...
	    <s:form id="startshopping"  action="startShopping" method="post">
         <h2 class="landingpage_hdr"> Welcome to your ParasDigital account</h2>
	      <div class="landingpage_txt">
		    <s:if test="%{#session.totalItems!=null && #session.totalItems==1}">
			  	
				  <p>You have <span style="color:green" > <strong> <s:property value="%{#session.totalItems}"/></strong></span>    item  in Your Shoppingcart and it's a little sad.</p>
				  <p>We have built it to hold all the mobiles, Cameras, Computers  and other items that are available at ParasDigitalWorld.</p>
				  <p>So please make your shopping cart happy and give its life a purpose!</p>				
				<div class="submitBut buttonChgPass"><a href="#" onclick="checkedValues();">CONTINUE SHOPPING</a></div>
			</s:if>
				
				
		    <s:elseif test="%{#session.totalItems!=null && #session.totalItems>1}">
				<p>You have <span style="color:green" > <strong> <s:property value="%{#session.totalItems}"/></strong></span>    items  in Your Shoppingcart.</p>
				<p>We have built it to hold all the mobiles, Cameras, Computers and other items that are available at ParasDigitalWorld.</p>
				<p>So please make your shopping cart happy and give its life a purpose!</p>
               <div class="submitBut buttonChgPass"><a href="#" onclick="checkedValues();">CONTINUE SHOPPING</a></div>
	        </s:elseif>
			...
			<s:elseif test="%{#session.totalItems==0}">
				<p>Your shopping cart is empty, and it's a little sad.</p>
				<p>We have built it to hold all the mobiles, Cameras, Computers  and other items that are available at ParasDigitalWorld.</p>
				<p>So please make your shopping cart happy and give its life a purpose!</p>
				<div class="submitBut buttonChgPass"><a href="#" onclick="checkedValues();">START SHOPPING</a></div></p>
			</s:elseif>
